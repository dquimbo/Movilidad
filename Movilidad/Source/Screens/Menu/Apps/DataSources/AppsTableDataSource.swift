...
class AppsTableDataSource: NSObject, UITableViewDataSource {
    // MARK: - Properties
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cellViewModel = MenuItemCellViewModel(operationItem: operationItem, tabType: .Apps, isLastCell: isLastRow)
